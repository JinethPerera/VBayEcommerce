...
try {
    ...
    $mail->SMTPAuth = true; 
    $mail->Username = 'jineth1perera@gmail.com'; 
    $mail->Password = 'sdaafffads'; 
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS; 
    $mail->Port = 587; 

    
    $mail->setFrom('jineth1perera@gmail.com', 'Your Name');
    $mail->addAddress($_POST['cust_email'], 'Customer'); 
    ...
    $mail->AltBody = 'Thank you for registering. Please verify your email by clicking the link: '.$verify_link;
